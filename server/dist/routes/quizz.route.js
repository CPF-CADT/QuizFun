...
router.get('/', authenicate_middleware_1.optionalAuthMiddleware, (0, validate_1.validate)(quiz_schemas_1.quizSchemas.getAllQuizzes), ratelimit_middleware_1.globalRateLimit, quizz_controller_1.getAllQuizzes);
