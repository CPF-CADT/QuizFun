...
const QuestionReportSchema = new mongoose_1.Schema({
    ...
    questionId: { type: mongoose_1.Schema.Types.ObjectId, required: true, index: true }, // Refers to the sub-document ID in Quiz.questions
    reporterId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
    reason: {
        type: String,
        enum: ['incorrect_answer', 'unclear_wording', 'typo', 'inappropriate_content', 'other'],
        required: true,
    },
