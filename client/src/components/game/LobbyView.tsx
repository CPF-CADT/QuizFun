...
export const LobbyView: React.FC<LobbyViewProps> = ({ gameState, onStartGame, onSettingsChange }) => {
    ...
    return (
        <div className="w-full max-w-2xl bg-white/10 backdrop-blur-md rounded-3xl p-8 shadow-2xl border-white/20 text-center animate-fade-in-up">
            ...
            {isHost && (
                <div className="mt-6 bg-white/10 p-4 rounded-xl space-y-4">
                    ...
                    />
                     <Link to="/dashboard" onClick={handleBackToHome} className="mt-4 text-indigo-400 hover:text-indigo-300 transition-colors font-medium flex items-center gap-2">
