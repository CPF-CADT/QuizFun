...
return (
    <div
      className="min-h-screen flex items-center justify-center relative overflow-hidden px-0 sm:p-4"
      style={{
    ...
    >
      ...
      <div className="w-full relative z-10 flex flex-col items-center justify-center p-0">
        <div className="w-full h-screen sm:h-auto sm:max-w-md
                      bg-gradient-to-br from-purple-600/90 via-purple-500/90 to-indigo-800/90 
                      backdrop-blur-xl p-6 sm:p-8 rounded-none sm:rounded-3xl shadow-none sm:shadow-2xl 
                      border-t sm:border border-white/20 relative z-10 sm:transform sm:hover:scale-[1.02]
                      transition-all duration-300 flex flex-col justify-start pt-16 sm:justify-center sm:pt-0">
          {/* Subtle Pattern */}
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8 mt-10">
              ...
              <p className="text-gray-300 text-lg sm:text-xl font-medium">Enter game details to start your adventure</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative group">
                  <input
                    ...
                    className="w-full px-2 py-2 rounded-2xl text-gray-800 text-center text-xl font-black tracking-[0.3em] bg-gray-50 outline-none focus:ring-4 focus:ring-purple-300/50 transition-all duration-300 border-2 border-gray-200 focus:border-purple-400 focus:bg-white shadow-lg"
                    required
                  />
                ...
                <div>
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className="w-full px-2 py-2 rounded-2xl text-gray-800 text-center text-xl font-bold bg-gray-50 outline-none focus:ring-4 focus:ring-cyan-300/50 transition-all duration-300 border-2 border-gray-200 focus:border-cyan-400 focus:bg-white shadow-lg"
                      required
                    />
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full relative overflow-hidden bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 disabled:from-gray-400 disabled:via-gray-500 disabled:to-gray-600 disabled:cursor-not-allowed text-white font-black py-4  px-4 rounded-2xl shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-3xl active:scale-95 group"
              >
                {/* Button Shine Effect */}
                ...
                <div className="relative flex items-center justify-center space-x-4">
                  {isLoading ? (
                    ...
                    <>
                      ...
                      <span className="text-xl font-black tracking-wide">JOIN GAME</span>
            ...
            <div className="mt-8 pt-6">
              <div className="h-px bg-gradient-to-r from-transparent via-gray-300/50 to-transparent w-full mb-4"></div>
