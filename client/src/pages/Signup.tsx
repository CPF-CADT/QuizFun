...
const ICONS = {
  ...
  gamepad:
    "M16.5 2h-9C6.67 2 6 2.67 6 3.5v11c0 .83.67 1.5 1.5 1.5h9c.83 0 1.5-.67 1.5-1.5v-11C18 2.67 17.33 2 16.5 2zM8 12H6v-2h2v2zm0-3H6V7h2v2zm3 3H9v-2h2v2zm0-3H9V7h2v2zm3 3h-2v-2h2v2zm0-3h-2V7h2v2zm3-2h-1V6h1v1zm0 2h-1V8h1v1zM4 18h16v2H4z",
  envelope:
