  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 lg:p-12">
        ...
        {/* Quiz Selection Grid */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Select a Quiz to Analyze</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            {quizzes.map((quiz, idx) => (
              ...
              >
                ...
                <p className="text-xs text-gray-600">{quiz.totalPlayers} players</p>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-2">
                <span className={`text-sm px-3 py-1 rounded-full ${getDifficultyColor(currentQuiz.difficulty)}`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            <div className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg rounded-xl p-4 text-center">
              ...
              <p className="text-xl font-bold text-gray-800">{currentQuiz.totalPlayers}</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg rounded-xl p-4 text-center">
              ...
              <p className="text-xl font-bold text-gray-800">{currentQuiz.attempts}</p>
            </div>

            <div className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg rounded-xl p-4 text-center">
              <div className="flex justify-center mb-2">
                <BarChart3 className={`w-6 h-6 ${getScoreColor(currentQuiz.averageScore)}`} />
              </div>
              <p className="text-sm text-gray-500">Avg Score</p>
              <p className={`text-xl font-bold ${getScoreColor(currentQuiz.averageScore)}`}>{currentQuiz.averageScore}%</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg rounded-xl p-4 text-center">
              ...
              <p className="text-xl font-bold text-emerald-600">{currentQuiz.highestScore}%</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg rounded-xl p-4 text-center">
              ...
              <p className="text-xl font-bold text-teal-600">{currentQuiz.completionRate}%</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg rounded-xl p-4 text-center">
              ...
              <p className="text-xl font-bold text-orange-600">{currentQuiz.averageTime}</p>
            </div>
          </div>
            ...
            <div className="bg-white/40 rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className={`font-medium ${currentQuiz.completionRate > 85 ? 'text-green-600' : 'text-yellow-600'}`}>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">{Math.round((currentQuiz.attempts / currentQuiz.totalPlayers - 1) * 100)}%</span>
                </div>
              </div>
            </div>
