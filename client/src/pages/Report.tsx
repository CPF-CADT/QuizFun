                                        ...
                                        <div className="w-full h-80">
                                            <ResponsiveContainer>
                                                <BarChart data={barData} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
                                                    ...
                                                    <Tooltip />
                                                    <Legend />
                                                    <Bar dataKey="Avg" name="Avg Score %" fill="#3b82f6" />
                                                    <Bar dataKey="Attempts" name="Sessions" fill="#22c55e" />
                                                    <Bar dataKey="Completion" name="Completion %" fill="#a855f7" />
                                                </BarChart>
                                            </ResponsiveContainer>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white/40 rounded-xl p-6">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className={`font-medium ${currentQuizData.completionRate > 85 ? "text-green-600" : "text-yellow-600"}`}>
                                                    {currentQuizData.completionRate > 85 ? "High" : "Moderate"}
                                                </span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className="text-gray-600">Difficulty Assessment</span>
                                                <span className="font-medium">{currentQuizData.averageScore > 80 ? "Appropriate" : "Consider reviewing"}</span>
                                            </div>
                                        </div>
                                    </div>
